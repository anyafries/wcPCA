"""
StablePCA Algorithm Implementation.

Code adapted on 15 Nov 2025 from 
https://github.com/zywang0701/StablePCA/tree/main
...
class StablePCA:
    ...
    def fit(self, Sigma_list, M_init=None, w_init=None, eta_init=None,
            max_iter=1000, tol=1e-6, verbose=True, adaptive=True,
            check_dual=False):
        # --------- Prepare Data --------- #
        L = len(Sigma_list)
        d = Sigma_list[0].shape[1]
